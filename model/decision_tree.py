"""
FIXED Decision Tree Classifier
...
def train_decision_tree_model(X, y):
    """Train Decision Tree model with class balancing"""
    print("\n" + "="*70)
    ...
    print("\nTraining Decision Tree model with class balancing...")
...
def save_model(model, scaler, filename='model/decision_tree_model.pkl'):
...
if __name__ == "__main__":
    ...
    model, scaler, metrics, X_test, y_test = train_decision_tree_model(X, y)
